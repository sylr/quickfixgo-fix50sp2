...
func (m RegistrationInstructions) SetClearingBusinessDate(v string) {
...
func (m RegistrationInstructions) GetClearingBusinessDate() (v string, err quickfix.MessageRejectError) {
...
func (m RegistrationInstructions) HasClearingBusinessDate() bool {
