package partyentitlementsupdatereport
...
// PartyEntitlementsUpdateReport is the fix50sp2 PartyEntitlementsUpdateReport type, MsgType = CZ.
type PartyEntitlementsUpdateReport struct {
	fixt11.Header
	*quickfix.Body
	fixt11.Trailer
...
// FromMessage creates a PartyEntitlementsUpdateReport from a quickfix.Message instance.
func FromMessage(m *quickfix.Message) PartyEntitlementsUpdateReport {
	return PartyEntitlementsUpdateReport{
...
func (m PartyEntitlementsUpdateReport) ToMessage() *quickfix.Message {
	return m.Message
}

// New returns a PartyEntitlementsUpdateReport initialized with the required fields for PartyEntitlementsUpdateReport.
func New(entitlementreportid field.EntitlementReportIDField) (m PartyEntitlementsUpdateReport) {
	m.Message = quickfix.NewMessage()
	m.Header = fixt11.NewHeader(&m.Message.Header)
	m.Body = &m.Message.Body
	m.Trailer.Trailer = &m.Message.Trailer

	m.Header.Set(field.NewMsgType("CZ"))
...
type RouteOut func(msg PartyEntitlementsUpdateReport, sessionID quickfix.SessionID) quickfix.MessageRejectError
...
func (m PartyEntitlementsUpdateReport) SetText(v string) {
	m.Set(field.NewText(v))
}

// SetTransactTime sets TransactTime, Tag 60.
func (m PartyEntitlementsUpdateReport) SetTransactTime(v time.Time) {
	m.Set(field.NewTransactTime(v))
}

// SetEncodedTextLen sets EncodedTextLen, Tag 354.
func (m PartyEntitlementsUpdateReport) SetEncodedTextLen(v int) {
	m.Set(field.NewEncodedTextLen(v))
}

// SetEncodedText sets EncodedText, Tag 355.
func (m PartyEntitlementsUpdateReport) SetEncodedText(v string) {
	m.Set(field.NewEncodedText(v))
}

// SetLastFragment sets LastFragment, Tag 893.
func (m PartyEntitlementsUpdateReport) SetLastFragment(v bool) {
	m.Set(field.NewLastFragment(v))
}

// SetApplID sets ApplID, Tag 1180.
func (m PartyEntitlementsUpdateReport) SetApplID(v string) {
	m.Set(field.NewApplID(v))
}

// SetApplSeqNum sets ApplSeqNum, Tag 1181.
func (m PartyEntitlementsUpdateReport) SetApplSeqNum(v int) {
	m.Set(field.NewApplSeqNum(v))
}

// SetApplLastSeqNum sets ApplLastSeqNum, Tag 1350.
func (m PartyEntitlementsUpdateReport) SetApplLastSeqNum(v int) {
	m.Set(field.NewApplLastSeqNum(v))
}

// SetApplResendFlag sets ApplResendFlag, Tag 1352.
func (m PartyEntitlementsUpdateReport) SetApplResendFlag(v bool) {
	m.Set(field.NewApplResendFlag(v))
}

// SetTotNoParties sets TotNoParties, Tag 1512.
func (m PartyEntitlementsUpdateReport) SetTotNoParties(v int) {
	m.Set(field.NewTotNoParties(v))
}

// SetNoRequestingPartyIDs sets NoRequestingPartyIDs, Tag 1657.
func (m PartyEntitlementsUpdateReport) SetNoRequestingPartyIDs(f NoRequestingPartyIDsRepeatingGroup) {
	m.SetGroup(f)
}

// SetEntitlementRequestID sets EntitlementRequestID, Tag 1770.
func (m PartyEntitlementsUpdateReport) SetEntitlementRequestID(v string) {
	m.Set(field.NewEntitlementRequestID(v))
}

// SetEntitlementReportID sets EntitlementReportID, Tag 1771.
func (m PartyEntitlementsUpdateReport) SetEntitlementReportID(v string) {
	m.Set(field.NewEntitlementReportID(v))
}

// SetNoPartyEntitlements sets NoPartyEntitlements, Tag 1772.
func (m PartyEntitlementsUpdateReport) SetNoPartyEntitlements(f NoPartyEntitlementsRepeatingGroup) {
	m.SetGroup(f)
}

// GetText gets Text, Tag 58.
func (m PartyEntitlementsUpdateReport) GetText() (v string, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetTransactTime() (v time.Time, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetEncodedTextLen() (v int, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetEncodedText() (v string, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetLastFragment() (v bool, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetApplID() (v string, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetApplSeqNum() (v int, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetApplLastSeqNum() (v int, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetApplResendFlag() (v bool, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetTotNoParties() (v int, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetNoRequestingPartyIDs() (NoRequestingPartyIDsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetEntitlementRequestID() (v string, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetEntitlementReportID() (v string, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsUpdateReport) GetNoPartyEntitlements() (NoPartyEntitlementsRepeatingGroup, quickfix.MessageRejectError) {
