package partyentitlementsdefinitionrequest
...
// PartyEntitlementsDefinitionRequest is the fix50sp2 PartyEntitlementsDefinitionRequest type, MsgType = DA.
type PartyEntitlementsDefinitionRequest struct {
	fixt11.Header
	*quickfix.Body
	fixt11.Trailer
...
// FromMessage creates a PartyEntitlementsDefinitionRequest from a quickfix.Message instance.
func FromMessage(m *quickfix.Message) PartyEntitlementsDefinitionRequest {
	return PartyEntitlementsDefinitionRequest{
...
func (m PartyEntitlementsDefinitionRequest) ToMessage() *quickfix.Message {
	return m.Message
}

// New returns a PartyEntitlementsDefinitionRequest initialized with the required fields for PartyEntitlementsDefinitionRequest.
func New(entitlementrequestid field.EntitlementRequestIDField) (m PartyEntitlementsDefinitionRequest) {
	m.Message = quickfix.NewMessage()
	m.Header = fixt11.NewHeader(&m.Message.Header)
	m.Body = &m.Message.Body
	m.Trailer.Trailer = &m.Message.Trailer

	m.Header.Set(field.NewMsgType("DA"))
...
type RouteOut func(msg PartyEntitlementsDefinitionRequest, sessionID quickfix.SessionID) quickfix.MessageRejectError
...
func (m PartyEntitlementsDefinitionRequest) SetText(v string) {
	m.Set(field.NewText(v))
}

// SetEncodedTextLen sets EncodedTextLen, Tag 354.
func (m PartyEntitlementsDefinitionRequest) SetEncodedTextLen(v int) {
	m.Set(field.NewEncodedTextLen(v))
}

// SetEncodedText sets EncodedText, Tag 355.
func (m PartyEntitlementsDefinitionRequest) SetEncodedText(v string) {
	m.Set(field.NewEncodedText(v))
}

// SetNoRequestingPartyIDs sets NoRequestingPartyIDs, Tag 1657.
func (m PartyEntitlementsDefinitionRequest) SetNoRequestingPartyIDs(f NoRequestingPartyIDsRepeatingGroup) {
	m.SetGroup(f)
}

// SetEntitlementRequestID sets EntitlementRequestID, Tag 1770.
func (m PartyEntitlementsDefinitionRequest) SetEntitlementRequestID(v string) {
	m.Set(field.NewEntitlementRequestID(v))
}

// SetNoPartyEntitlements sets NoPartyEntitlements, Tag 1772.
func (m PartyEntitlementsDefinitionRequest) SetNoPartyEntitlements(f NoPartyEntitlementsRepeatingGroup) {
	m.SetGroup(f)
}

// GetText gets Text, Tag 58.
func (m PartyEntitlementsDefinitionRequest) GetText() (v string, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsDefinitionRequest) GetEncodedTextLen() (v int, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsDefinitionRequest) GetEncodedText() (v string, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsDefinitionRequest) GetNoRequestingPartyIDs() (NoRequestingPartyIDsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m PartyEntitlementsDefinitionRequest) GetEntitlementRequestID() (v string, err quickfix.MessageRejectError) {
...
func (m PartyEntitlementsDefinitionRequest) GetNoPartyEntitlements() (NoPartyEntitlementsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m PartyEntitlementsDefinitionRequest) HasText() bool {
	return m.Has(tag.Text)
}

// HasEncodedTextLen returns true if EncodedTextLen is present, Tag 354.
func (m PartyEntitlementsDefinitionRequest) HasEncodedTextLen() bool {
	return m.Has(tag.EncodedTextLen)
}

// HasEncodedText returns true if EncodedText is present, Tag 355.
func (m PartyEntitlementsDefinitionRequest) HasEncodedText() bool {
	return m.Has(tag.EncodedText)
}

// HasNoRequestingPartyIDs returns true if NoRequestingPartyIDs is present, Tag 1657.
func (m PartyEntitlementsDefinitionRequest) HasNoRequestingPartyIDs() bool {
	return m.Has(tag.NoRequestingPartyIDs)
}

// HasEntitlementRequestID returns true if EntitlementRequestID is present, Tag 1770.
func (m PartyEntitlementsDefinitionRequest) HasEntitlementRequestID() bool {
	return m.Has(tag.EntitlementRequestID)
}

// HasNoPartyEntitlements returns true if NoPartyEntitlements is present, Tag 1772.
func (m PartyEntitlementsDefinitionRequest) HasNoPartyEntitlements() bool {
