package partydetailsdefinitionrequest
...
// PartyDetailsDefinitionRequest is the fix50sp2 PartyDetailsDefinitionRequest type, MsgType = CX.
type PartyDetailsDefinitionRequest struct {
	fixt11.Header
	*quickfix.Body
	fixt11.Trailer
...
// FromMessage creates a PartyDetailsDefinitionRequest from a quickfix.Message instance.
func FromMessage(m *quickfix.Message) PartyDetailsDefinitionRequest {
	return PartyDetailsDefinitionRequest{
...
func (m PartyDetailsDefinitionRequest) ToMessage() *quickfix.Message {
	return m.Message
}

// New returns a PartyDetailsDefinitionRequest initialized with the required fields for PartyDetailsDefinitionRequest.
func New(partydetailslistrequestid field.PartyDetailsListRequestIDField) (m PartyDetailsDefinitionRequest) {
	m.Message = quickfix.NewMessage()
	m.Header = fixt11.NewHeader(&m.Message.Header)
	m.Body = &m.Message.Body
	m.Trailer.Trailer = &m.Message.Trailer

	m.Header.Set(field.NewMsgType("CX"))
...
type RouteOut func(msg PartyDetailsDefinitionRequest, sessionID quickfix.SessionID) quickfix.MessageRejectError
...
func (m PartyDetailsDefinitionRequest) SetText(v string) {
	m.Set(field.NewText(v))
}

// SetEncodedTextLen sets EncodedTextLen, Tag 354.
func (m PartyDetailsDefinitionRequest) SetEncodedTextLen(v int) {
	m.Set(field.NewEncodedTextLen(v))
}

// SetEncodedText sets EncodedText, Tag 355.
func (m PartyDetailsDefinitionRequest) SetEncodedText(v string) {
	m.Set(field.NewEncodedText(v))
}

// SetPartyDetailsListRequestID sets PartyDetailsListRequestID, Tag 1505.
func (m PartyDetailsDefinitionRequest) SetPartyDetailsListRequestID(v string) {
	m.Set(field.NewPartyDetailsListRequestID(v))
}

// SetNoRequestingPartyIDs sets NoRequestingPartyIDs, Tag 1657.
func (m PartyDetailsDefinitionRequest) SetNoRequestingPartyIDs(f NoRequestingPartyIDsRepeatingGroup) {
	m.SetGroup(f)
}

// SetNoPartyUpdates sets NoPartyUpdates, Tag 1676.
func (m PartyDetailsDefinitionRequest) SetNoPartyUpdates(f NoPartyUpdatesRepeatingGroup) {
	m.SetGroup(f)
}

// GetText gets Text, Tag 58.
func (m PartyDetailsDefinitionRequest) GetText() (v string, err quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequest) GetEncodedTextLen() (v int, err quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequest) GetEncodedText() (v string, err quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequest) GetPartyDetailsListRequestID() (v string, err quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequest) GetNoRequestingPartyIDs() (NoRequestingPartyIDsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequest) GetNoPartyUpdates() (NoPartyUpdatesRepeatingGroup, quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequest) HasText() bool {
	return m.Has(tag.Text)
}

// HasEncodedTextLen returns true if EncodedTextLen is present, Tag 354.
func (m PartyDetailsDefinitionRequest) HasEncodedTextLen() bool {
	return m.Has(tag.EncodedTextLen)
}

// HasEncodedText returns true if EncodedText is present, Tag 355.
func (m PartyDetailsDefinitionRequest) HasEncodedText() bool {
	return m.Has(tag.EncodedText)
}

// HasPartyDetailsListRequestID returns true if PartyDetailsListRequestID is present, Tag 1505.
func (m PartyDetailsDefinitionRequest) HasPartyDetailsListRequestID() bool {
...
func (m PartyDetailsDefinitionRequest) HasNoRequestingPartyIDs() bool {
	return m.Has(tag.NoRequestingPartyIDs)
}

// HasNoPartyUpdates returns true if NoPartyUpdates is present, Tag 1676.
func (m PartyDetailsDefinitionRequest) HasNoPartyUpdates() bool {
