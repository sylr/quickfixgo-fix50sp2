package partydetailsdefinitionrequestack
...
// PartyDetailsDefinitionRequestAck is the fix50sp2 PartyDetailsDefinitionRequestAck type, MsgType = CY.
type PartyDetailsDefinitionRequestAck struct {
	fixt11.Header
	*quickfix.Body
	fixt11.Trailer
...
// FromMessage creates a PartyDetailsDefinitionRequestAck from a quickfix.Message instance.
func FromMessage(m *quickfix.Message) PartyDetailsDefinitionRequestAck {
	return PartyDetailsDefinitionRequestAck{
...
func (m PartyDetailsDefinitionRequestAck) ToMessage() *quickfix.Message {
	return m.Message
}

// New returns a PartyDetailsDefinitionRequestAck initialized with the required fields for PartyDetailsDefinitionRequestAck.
func New(partydetailslistrequestid field.PartyDetailsListRequestIDField, partydetailrequeststatus field.PartyDetailRequestStatusField) (m PartyDetailsDefinitionRequestAck) {
	m.Message = quickfix.NewMessage()
	m.Header = fixt11.NewHeader(&m.Message.Header)
	m.Body = &m.Message.Body
	m.Trailer.Trailer = &m.Message.Trailer

	m.Header.Set(field.NewMsgType("CY"))
	m.Set(partydetailslistrequestid)
	m.Set(partydetailrequeststatus)

	return
}

// A RouteOut is the callback type that should be implemented for routing Message.
type RouteOut func(msg PartyDetailsDefinitionRequestAck, sessionID quickfix.SessionID) quickfix.MessageRejectError
...
func (m PartyDetailsDefinitionRequestAck) SetText(v string) {
	m.Set(field.NewText(v))
}

// SetEncodedTextLen sets EncodedTextLen, Tag 354.
func (m PartyDetailsDefinitionRequestAck) SetEncodedTextLen(v int) {
	m.Set(field.NewEncodedTextLen(v))
}

// SetEncodedText sets EncodedText, Tag 355.
func (m PartyDetailsDefinitionRequestAck) SetEncodedText(v string) {
	m.Set(field.NewEncodedText(v))
}

// SetPartyDetailsListRequestID sets PartyDetailsListRequestID, Tag 1505.
func (m PartyDetailsDefinitionRequestAck) SetPartyDetailsListRequestID(v string) {
	m.Set(field.NewPartyDetailsListRequestID(v))
}

// SetNoRequestingPartyIDs sets NoRequestingPartyIDs, Tag 1657.
func (m PartyDetailsDefinitionRequestAck) SetNoRequestingPartyIDs(f NoRequestingPartyIDsRepeatingGroup) {
	m.SetGroup(f)
}

// SetNoPartyUpdates sets NoPartyUpdates, Tag 1676.
func (m PartyDetailsDefinitionRequestAck) SetNoPartyUpdates(f NoPartyUpdatesRepeatingGroup) {
	m.SetGroup(f)
}

// SetPartyDetailRequestResult sets PartyDetailRequestResult, Tag 1877.
func (m PartyDetailsDefinitionRequestAck) SetPartyDetailRequestResult(v enum.PartyDetailRequestResult) {
	m.Set(field.NewPartyDetailRequestResult(v))
}

// SetPartyDetailRequestStatus sets PartyDetailRequestStatus, Tag 1878.
func (m PartyDetailsDefinitionRequestAck) SetPartyDetailRequestStatus(v enum.PartyDetailRequestStatus) {
	m.Set(field.NewPartyDetailRequestStatus(v))
}

// GetText gets Text, Tag 58.
func (m PartyDetailsDefinitionRequestAck) GetText() (v string, err quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequestAck) GetEncodedTextLen() (v int, err quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequestAck) GetEncodedText() (v string, err quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequestAck) GetPartyDetailsListRequestID() (v string, err quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequestAck) GetNoRequestingPartyIDs() (NoRequestingPartyIDsRepeatingGroup, quickfix.MessageRejectError) {
...
func (m PartyDetailsDefinitionRequestAck) GetNoPartyUpdates() (NoPartyUpdatesRepeatingGroup, quickfix.MessageRejectError) {
	f := NewNoPartyUpdatesRepeatingGroup()
	err := m.GetGroup(f)
	return f, err
}

// GetPartyDetailRequestResult gets PartyDetailRequestResult, Tag 1877.
func (m PartyDetailsDefinitionRequestAck) GetPartyDetailRequestResult() (v enum.PartyDetailRequestResult, err quickfix.MessageRejectError) {
	var f field.PartyDetailRequestResultField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// GetPartyDetailRequestStatus gets PartyDetailRequestStatus, Tag 1878.
func (m PartyDetailsDefinitionRequestAck) GetPartyDetailRequestStatus() (v enum.PartyDetailRequestStatus, err quickfix.MessageRejectError) {
	var f field.PartyDetailRequestStatusField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m PartyDetailsDefinitionRequestAck) HasText() bool {
	return m.Has(tag.Text)
}

// HasEncodedTextLen returns true if EncodedTextLen is present, Tag 354.
func (m PartyDetailsDefinitionRequestAck) HasEncodedTextLen() bool {
	return m.Has(tag.EncodedTextLen)
}

// HasEncodedText returns true if EncodedText is present, Tag 355.
func (m PartyDetailsDefinitionRequestAck) HasEncodedText() bool {
	return m.Has(tag.EncodedText)
}

// HasPartyDetailsListRequestID returns true if PartyDetailsListRequestID is present, Tag 1505.
func (m PartyDetailsDefinitionRequestAck) HasPartyDetailsListRequestID() bool {
...
func (m PartyDetailsDefinitionRequestAck) HasNoRequestingPartyIDs() bool {
	return m.Has(tag.NoRequestingPartyIDs)
}

// HasNoPartyUpdates returns true if NoPartyUpdates is present, Tag 1676.
func (m PartyDetailsDefinitionRequestAck) HasNoPartyUpdates() bool {
	return m.Has(tag.NoPartyUpdates)
}

// HasPartyDetailRequestResult returns true if PartyDetailRequestResult is present, Tag 1877.
func (m PartyDetailsDefinitionRequestAck) HasPartyDetailRequestResult() bool {
	return m.Has(tag.PartyDetailRequestResult)
}

// HasPartyDetailRequestStatus returns true if PartyDetailRequestStatus is present, Tag 1878.
func (m PartyDetailsDefinitionRequestAck) HasPartyDetailRequestStatus() bool {
	return m.Has(tag.PartyDetailRequestStatus)
}
...
// SetPartyDetailDefinitionStatus sets PartyDetailDefinitionStatus, Tag 1879.
func (m NoPartyUpdates) SetPartyDetailDefinitionStatus(v enum.PartyDetailDefinitionStatus) {
	m.Set(field.NewPartyDetailDefinitionStatus(v))
}

// SetPartyDetailDefinitionResult sets PartyDetailDefinitionResult, Tag 1880.
func (m NoPartyUpdates) SetPartyDetailDefinitionResult(v int) {
	m.Set(field.NewPartyDetailDefinitionResult(v))
}

// SetRejectText sets RejectText, Tag 1328.
func (m NoPartyUpdates) SetRejectText(v string) {
	m.Set(field.NewRejectText(v))
}

// SetEncodedRejectTextLen sets EncodedRejectTextLen, Tag 1664.
func (m NoPartyUpdates) SetEncodedRejectTextLen(v int) {
	m.Set(field.NewEncodedRejectTextLen(v))
}

// SetEncodedRejectText sets EncodedRejectText, Tag 1665.
func (m NoPartyUpdates) SetEncodedRejectText(v string) {
...
// GetPartyDetailDefinitionStatus gets PartyDetailDefinitionStatus, Tag 1879.
func (m NoPartyUpdates) GetPartyDetailDefinitionStatus() (v enum.PartyDetailDefinitionStatus, err quickfix.MessageRejectError) {
	var f field.PartyDetailDefinitionStatusField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// GetPartyDetailDefinitionResult gets PartyDetailDefinitionResult, Tag 1880.
func (m NoPartyUpdates) GetPartyDetailDefinitionResult() (v int, err quickfix.MessageRejectError) {
	var f field.PartyDetailDefinitionResultField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
func (m NoPartyUpdates) GetRejectText() (v string, err quickfix.MessageRejectError) {
...
func (m NoPartyUpdates) GetEncodedRejectTextLen() (v int, err quickfix.MessageRejectError) {
...
func (m NoPartyUpdates) GetEncodedRejectText() (v string, err quickfix.MessageRejectError) {
...
// HasPartyDetailDefinitionStatus returns true if PartyDetailDefinitionStatus is present, Tag 1879.
func (m NoPartyUpdates) HasPartyDetailDefinitionStatus() bool {
	return m.Has(tag.PartyDetailDefinitionStatus)
}

// HasPartyDetailDefinitionResult returns true if PartyDetailDefinitionResult is present, Tag 1880.
func (m NoPartyUpdates) HasPartyDetailDefinitionResult() bool {
	return m.Has(tag.PartyDetailDefinitionResult)
}

// HasRejectText returns true if RejectText is present, Tag 1328.
func (m NoPartyUpdates) HasRejectText() bool {
	return m.Has(tag.RejectText)
}

// HasEncodedRejectTextLen returns true if EncodedRejectTextLen is present, Tag 1664.
func (m NoPartyUpdates) HasEncodedRejectTextLen() bool {
	return m.Has(tag.EncodedRejectTextLen)
}

// HasEncodedRejectText returns true if EncodedRejectText is present, Tag 1665.
func (m NoPartyUpdates) HasEncodedRejectText() bool {
	...
	return NoPartyUpdatesRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.PartyDetailDefinitionStatus),
				quickfix.GroupElement(tag.PartyDetailDefinitionResult),
