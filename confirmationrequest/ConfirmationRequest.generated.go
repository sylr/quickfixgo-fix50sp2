...
// SetNested2PartyRoleQualifier sets Nested2PartyRoleQualifier, Tag 2381.
func (m NoNested2PartyIDs) SetNested2PartyRoleQualifier(v int) {
	m.Set(field.NewNested2PartyRoleQualifier(v))
}
...
// GetNested2PartyRoleQualifier gets Nested2PartyRoleQualifier, Tag 2381.
func (m NoNested2PartyIDs) GetNested2PartyRoleQualifier() (v int, err quickfix.MessageRejectError) {
	var f field.Nested2PartyRoleQualifierField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// HasNested2PartyRoleQualifier returns true if Nested2PartyRoleQualifier is present, Tag 2381.
func (m NoNested2PartyIDs) HasNested2PartyRoleQualifier() bool {
	return m.Has(tag.Nested2PartyRoleQualifier)
}
	...
	return NoNested2PartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.Nested2PartyRoleQualifier),
			},
		),
	}
}
