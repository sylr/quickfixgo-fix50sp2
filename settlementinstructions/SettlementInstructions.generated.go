...
func (m NoSettlInst) SetUPICode(v string) {
...
func (m NoSettlInst) GetUPICode() (v string, err quickfix.MessageRejectError) {
...
func (m NoSettlInst) HasUPICode() bool {
...
// SetSettlPartyRoleQualifier sets SettlPartyRoleQualifier, Tag 2389.
func (m NoSettlPartyIDs) SetSettlPartyRoleQualifier(v int) {
	m.Set(field.NewSettlPartyRoleQualifier(v))
}
...
// GetSettlPartyRoleQualifier gets SettlPartyRoleQualifier, Tag 2389.
func (m NoSettlPartyIDs) GetSettlPartyRoleQualifier() (v int, err quickfix.MessageRejectError) {
	var f field.SettlPartyRoleQualifierField
	if err = m.Get(&f); err == nil {
		v = f.Value()
	}
	return
...
// HasSettlPartyRoleQualifier returns true if SettlPartyRoleQualifier is present, Tag 2389.
func (m NoSettlPartyIDs) HasSettlPartyRoleQualifier() bool {
	return m.Has(tag.SettlPartyRoleQualifier)
}
	...
	return NoSettlPartyIDsRepeatingGroup{
		quickfix.NewRepeatingGroup(
			...
			quickfix.GroupTemplate{
				...
				quickfix.GroupElement(tag.SettlPartyRoleQualifier),
			},
		),
	}
}
