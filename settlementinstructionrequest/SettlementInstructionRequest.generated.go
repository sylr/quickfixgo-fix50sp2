...
func (m SettlementInstructionRequest) SetUPICode(v string) {
...
func (m SettlementInstructionRequest) GetUPICode() (v string, err quickfix.MessageRejectError) {
...
func (m SettlementInstructionRequest) HasUPICode() bool {
